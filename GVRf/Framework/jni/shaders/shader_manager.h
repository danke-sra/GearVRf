...
#include "shaders/material/mesh_animation_shader.h"
...
public:
    ShaderManager() :
            ...
            external_renderer_shader_(), mesh_animation_shader_(), error_shader_(),
    ...
    MeshAnimationShader* getMeshAnimationShader() {
        if (!mesh_animation_shader_) {
            mesh_animation_shader_ = new MeshAnimationShader();
        }
        return mesh_animation_shader_;
    }
...
private:
    ...
    MeshAnimationShader* mesh_animation_shader_;
