...
public class GVRAndroidResource {
    ...
    /**
     * Creates another {@code GVRAndroidResource} instance to hold
     * a file opened at the same directory as this {@code GVRAndroidResource}
     * instance.
     *
     * @return The new {@code GVRAndroidResource} object.
     */
    public GVRAndroidResource openFileInSameLocation(String path) {
        return null;
    }
