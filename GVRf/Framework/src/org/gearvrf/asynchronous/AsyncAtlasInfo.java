...
abstract class AsyncAtlasInfo {
    ...
    /**
     * This method is a sync parse to the JSON stream of atlas informations.
     *
     * @return List of atlas informations.
     */
    public static List<GVRAtlasInformation> loadAtlasInformations(InputStream ins) {
        try {
            ...
            return loadAtlasInformations(new JSONArray(new String(buffer, "UTF-8")));
    ...
    private static List<GVRAtlasInformation> loadAtlasInformations(JSONArray jsonInfo) throws JSONException {
