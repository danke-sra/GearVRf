...
public abstract class GVRContext {
     ...
     *
     * Atlas information file contains in UV space the informations of offset and
     ...
     *
     * @return List of atlas informations load.
     */
    public List<GVRAtlasInformation> loadTextureAtlasInformations(GVRAndroidResource resource) {

        assertGLThread();

        List<GVRAtlasInformation> atlasInformations
                = GVRAsynchronousResourceLoader.loadAtlasInformations(resource.getStream());
        resource.closeStream();

        return atlasInformations;
    }
