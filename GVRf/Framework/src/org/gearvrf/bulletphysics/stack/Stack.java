 ...
 * JStackAlloc (c) 2016 Danke Xie <danke.xie@gmail.com>
 *     Modified for Android following http://ameblo.jp/guojia/theme-10051299279.html
 *     Fixed raw types
 *
...
package org.gearvrf.bulletphysics.stack;
...
public class Stack {	
	 ...
	 *
	 * @param cls The class to be allocated.
	 * @return An instance of the class.
	 *
	 */
	//  See http://ameblo.jp/guojia/theme-10051299279.html
	...
	public static <T> T alloc(T obj) {
	    ...
	    try {
	        // コピーコンストラクタがある事大前提(良い子は真似しないでね?)
	        constructor = (Constructor<T>) obj.getClass().getConstructor(obj.getClass());
